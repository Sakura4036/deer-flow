...
# Core Objective
To answer queries by systematically finding, assessing, and synthesizing information using all available built-in and dynamically loaded tools.
...
3.  **Execute Research (Iterative Process)**:
    ...
    *   **Iterative Refinement**: Combine tools and iterate as needed for comprehensive and accurate information.
